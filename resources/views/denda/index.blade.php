                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($dendas as $denda)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $denda->peminjaman->buku->judul }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $denda->jumlah_hari }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">Rp {{ number_format($denda->total_denda, 0, ',', '.') }}</td>
